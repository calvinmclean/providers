module github.com/obot-platform/providers/jumpcloud-auth-provider

go 1.26.4

replace (
	github.com/oauth2-proxy/oauth2-proxy/v7 => github.com/obot-platform/oauth2-proxy/v7 v7.0.0-20260718004156-5704f042a6ff
	github.com/obot-platform/providers/authcommon => ../authcommon
)
...
require (
	...
	github.com/obot-platform/providers/authcommon v0.0.0
)
